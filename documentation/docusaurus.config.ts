...
const config: Config = {
  ...
  projectName: process.env.ENV_REPOSITORY_URL ? process.env.ENV_REPOSITORY_URL : 'https://github.com/sonbae-corp/rag-with-ai-foundry-m365-workshop', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: process.env.ENV_REPOSITORY_URL ? process.env.ENV_REPOSITORY_URL : 'https://github.com/sonbae-corp/rag-with-ai-foundry-m365-workshop',
  ...
  themeConfig: {
    navbar: {
      ...
      items: [
        ...
        {
          href: process.env.ENV_REPOSITORY_URL ? process.env.ENV_REPOSITORY_URL : 'https://github.com/sonbae-corp/rag-with-ai-foundry-m365-workshop',
          position: 'right',
          html: `
              <a style="display:flex" href="https://github.com/sonbae-corp/rag-with-ai-foundry-m365-workshop" target="_blank" rel="noreferrer noopener">
    ...
    metadata: [
      ...
      {name: 'docusaurOpsProjectRepository', property: "docusaurOpsProjectRepository", content: process.env.ENV_REPOSITORY_URL ? process.env.ENV_REPOSITORY_URL : 'https://github.com/sonbae-corp/rag-with-ai-foundry-m365-workshop'},
