...
<div className="flex items-center mb-10">
    ...
    <div className='w-full'>This sample solution is available in the workshop source repository. Use the repository URL: [https://github.com/sonbae-corp/rag-with-ai-foundry-m365-workshop](https://github.com/sonbae-corp/rag-with-ai-foundry-m365-workshop).</div>
</div>
::: 
