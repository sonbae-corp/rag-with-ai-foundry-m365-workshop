...
<div className="flex items-center mb-10">
    ...
    <div className='w-full'>This sample solution is available in the workshop source repository. Use the repository URL shared with your cohort.</div>
</div>
::: 
